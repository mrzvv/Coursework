...
<title>ОАО "Приорбанк" - выдача средств с текущего счета</title>
<style>
...
<body>
	...
	<div class="wrapper">
		<form action="<%=request.getContextPath()%>/" method="post">
			...
			<div class="content">
				<hr>
					<h4 id="box">Выдача средств депозитного счета ОАО "Приорбанк"</h4>
					<hr>
						<div id="header">
							<div class="line">
						...
						<table width="device-width" align="center">
							...
							<tr>
								<td valign="top">
									<table>
									<p id="module"> Введите необходимую информацию <br /> для изъятия средств с клиентского счета <br /> (депозит <%=deposit.getContractId()%>): </p>
										<p style="margin-left: 47px; font-size: 15px;">Сумма изъятия:</p>
										<tr>
											<td><input style="margin-left: 43px;" type="text" name="takeAwaySum" /></td>
										</tr>
