...
<title>ОАО "Приорбанк" - возврат изъятых средств</title>
<style>
...
<body>
	...
	<div class="wrapper">
		<form action="<%=request.getContextPath()%>/" method="post">
			...
			<div class="content">
				<hr>
					<h4 id="box">Возврат изъятых со счета клиента средств для нужд банка ОАО "Приорбанк"</h4>
					<hr>
						<div id="header">
							<div class="line">
						...
						<table width="device-width" align="center">
							<tr>
								<td valign="top">
									<p id="module">Подтвердите возврат изъятых средств<br /> по депозиту <%=deposit.getContractId()%>: </p>
									<table>
										<td colspan="2" align="center"><input id="button1"
