...
<title>ОАО "Приорбанк" - начисление процентов</title>
<style>
...
<body>
	...
	<div class="wrapper">
		<form action="<%=request.getContextPath()%>/" method="post">
			...
			<div class="content">
				<hr>
					<h4 id="box">Начисление процентов по депозитному счету ОАО "Приорбанк"</h4>
					<hr>
						<div id="header">
							<div class="line">
						...
						<table width="device-width" align="center">
							<tr>
								<td valign="top">
									<p id="module" >Подтвердите начисление процентов<br /> по депозиту <%=deposit.getContractId()%>: </p>
									<table>
