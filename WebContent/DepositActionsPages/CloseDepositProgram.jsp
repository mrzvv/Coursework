...
<title>ОАО "Приорбанк" - закрытие депозитного счета</title>
<style>
...
<body>
	...
	<div class="wrapper">
		<form action="<%=request.getContextPath()%>/" method="post">
			...
			<div class="content">
				<hr>
					<h4 id="box">Закрытие депозитного счета ОАО "Приорбанк"</h4>
					<hr>
						<div id="header">
							<div class="line">
						...
						<table width="device-width" align="center">
							...
							<tr>
								<td valign="top">
									<p id="module">Введите дату закрытия депозита <%=deposit.getContractId()%>: </p>
									<table>
										<tr><td colspan="2"><input style="margin-left: 43px;" type="text" name="closureDate"/></td> </tr>
										<tr><td colspan="2"><input id="button1"
											type="submit" name="<%=jsp_parameters.get("next_action")%>"
											value="<%=jsp_parameters.get("next_action_label")%>" /> <br /></td></tr>
									</table>
									<p style="margin-left: 43px; color: red; font-size: 15px;">Внимание! Закрытие депозита - необратимая операция. <br /> После закрытия внести изменения в депозит невозможно. <br /> Депозит будет доступен в разделе "Архив депозитов".</p>
								</td>
