...
<title>ОАО "Приорбанк" - пассивный счет 7327 Фонд развития банка</title>
<style>
...
<body>
	...
	<%
		...
		Account bank_fund = bank.getBankAccounts().get("Счет фонда развития банка");
	...
	<div class="wrapper">
		<div class="content">
			<hr>
				<h4 id="box">Информация по счету 7327 Фонд развития банка ОАО "Приорбанк"</h4>
				<hr>
					<div id="header">
						<div class="line">
					...
					<table align="center" width="80%" class="data">
						...
						<%
							for (Operation operations_fund : bank_fund.getAccountOperations().values()) {
						%>
						<tr>
							<td class="col1"><%=operations_fund.getOperationId()%></td>
							<td><%=operations_fund.getOperationDescription()%></td>
							<td><%=operations_fund.getDebit()%></td>
							<td><%=operations_fund.getCredit()%></td>
						</tr>
						<%
							}
						%>
