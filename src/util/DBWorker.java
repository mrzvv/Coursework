	...
	public ResultSet getDBData(String query) {
		...
		try {
			...
			connect = DriverManager.getConnection(
					"jdbc:mysql://localhost/bankwork?user=root&password=root&useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&connectionCollation=utf8_general_ci");
